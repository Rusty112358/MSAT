...
<br>![image](https://github.com/user-attachments/assets/b7da71eb-a79f-49be-9bec-7fb45ba316cd)
 <br>
The data was pulled from hundreds of reports generated by various systems.  Directly accessing the tables would serve no benefits since the data stored in the table are inaccurate.  For example identifying which part was installed on which aircraft. The reports will correctly identify the part to the aircraft, but it does not uniquely identify the aircraft. That part could be installed on 100 different aircraft and some of those aircrafts could have the same identifier. How do you tell the difference between ten different aircrafts that have the same identifier. That is a challenge.  
